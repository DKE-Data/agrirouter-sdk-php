...
namespace Lib\Tests\Service\Onboard {
    ...
    class RevokeServiceTestForFarmingSoftware extends AbstractIntegrationTestForServices
    {
        ...
        public function testGivenNonExistingEndpointWhenRevokingFarmingSoftwareThenThereShouldBeAnException()
        {
            ...
            $revokeParameters->setApplicationId(FarmingSoftware::applicationId());
            $revokeParameters->setOffset(timezone_offset_get(new DateTimeZone('Europe/Berlin'), new DateTime()));
            $revokeService->revoke($revokeParameters, FarmingSoftware::privateKey());
        }
        ...
        public function testGivenExistingEndpointWhenRevokingFarmingSoftwareThenThereShouldBeAValidResponse():void
        {
            ...
            self::assertNull($revokeService->revoke($revokeParameters, FarmingSoftware::privateKey()));
        }
    }
}
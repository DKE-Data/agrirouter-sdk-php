...
namespace Lib\Tests\Service\Onboard {
    ...
    class RevokeServiceTestForFarmingSoftware extends AbstractIntegrationTestForServices
    {
         ...
         */
        public function testGivenNonExistingEndpointWhenRevokingFarmingSoftwareThenThereShouldBeAnException()
        {
            ...
            $revokeParamaters->setApplicationId(FarmingSoftware::applicationId());
            $revokeParamaters->setOffset(timezone_offset_get(new DateTimeZone('Europe/Berlin'), new DateTime()));
            $revokeService->revoke($revokeParamaters, FarmingSoftware::privateKey());
        }
         ...
         */
        public function testGivenExistingEndpointWhenRevokingFarmingSoftwareThenThereShouldBeAValidResponse()
        {
            ...
            $revokeParamaters->setApplicationId(FarmingSoftware::applicationId());
            $revokeParamaters->setOffset(timezone_offset_get(new DateTimeZone('Europe/Berlin'), new DateTime()));
            self::assertNull($revokeService->revoke($revokeParamaters, FarmingSoftware::privateKey()));
        }
    }
}